(deftheme fairyfloss
  "Modified version from the one generated by the tm2deftheme gem. Created 2017-11-06.
   ...
   As you can see below, it's a pain to edit this by hand.
   You can customize this theme by using M-x customize-create-theme and loading this theme through the 'Visit Theme' button.")

(custom-theme-set-faces
 'fairyfloss
 '(region ((t (:background "color-203"))))
