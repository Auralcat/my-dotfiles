...
# Current default mode for this buffer is: Org-mode.")
 ...
 '(package-selected-packages
   '(ox-jira undo-fu base16-theme esup solo-jazz-theme haskell-mode ob-mermaid mermaid-mode zenburn-theme gherkin-mode railscasts-theme symbol-overlay inf-clojure clojure-mode notmuch erlang modus-vivendi-theme github-modern-theme github-theme paper-theme all-the-icons ox-gfm nov mix dockerfile-mode exec-path-from-shell forge nord-theme modus-operandi-theme night-owl-theme gruvbox-theme apib-mode guess-language flycheck-inline font-lock+ flatui-theme twilight-bright-theme hemisu-theme cl-lib yasnippet-snippets flycheck-credo evil-numbers yaml-mode evil-matchit circadian diminish writeroom-mode jazz-theme restart-emacs doom-themes yasnippet-classic-snippets ob-elixir company-prescient web-mode web-beautify use-package sass-mode rust-mode ruby-tools request rainbow-mode rainbow-delimiters projectile org-bullets nyan-mode mode-icons magit keyfreq js2-mode flymake-elixir flycheck-mix evil-surround evil-leader evil-anzu emojify emmet-mode editorconfig csv-mode company-web company-statistics company-php cl-generic autopair ac-html-bootstrap abyss-theme))
