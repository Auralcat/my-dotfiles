...
(when (eq system-type 'darwin) ;; mac specific settings
  ...
  (if (member "Fantasque Sans Mono" (font-family-list))
      (set-face-attribute (quote default) nil :font "Courier Prime" :height 120)
...
(setq-default gc-cons-threshold 40265318400
...
(defun auralcat--set-fonts-for-gnu-linux (height)
  ...
  (if (font-info "Courier Prime")
      (auralcat--set-fixed-pitch-fonts "Courier Prime" height)
