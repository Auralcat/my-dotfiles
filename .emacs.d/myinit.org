...
(setq auralcat/mode-line-left-side
      (list " " evil-mode-line-tag " " mode-line-buffer-identification " " mode-line-modified " " mode-name " "'(vc-mode vc-mode)))
(setq auralcat/mode-line-right-side
      (list  minor-mode-alist " " mode-line-misc-info " " mode-line-end-spaces))
