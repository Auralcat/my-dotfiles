...
(defun auralcat/set-up-olivetti-for-outline-mode ()
  "Initialization steps for olivetti-mode."
  (setq olivetti-body-width 104)
  (olivetti-mode 'toggle))

(add-hook 'outline-mode-hook 'auralcat/set-up-olivetti-for-outline-mode)
(add-hook 'livemd-mode-hook 'auralcat/set-up-olivetti-for-outline-mode)
#+END_SRC
*** Golden Ratio Mode
...
(defun auralcat/org-remap-heading-faces ()
  (face-remap-add-relative 'org-level-1 :height 1.6)
  (face-remap-add-relative 'org-document-title :height 1.6)
  (face-remap-add-relative 'org-document-info :height 1.4)
  (face-remap-add-relative 'org-level-2 :height 1.4)
  (face-remap-add-relative 'org-level-3 :height 1.2))
