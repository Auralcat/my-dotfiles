...
* IRC
** Circe setup
Trying it out with Circe for now.
#+BEGIN_SRC emacs-lisp :tangle yes
(use-package circe
  :config
...
;; For more configuration, check https://github.com/emacs-circe/circe/wiki/Configuration
(setq circe-format-server-topic "*** Topic change by {userhost}: {topic-diff}")

;; Show the nicks beside the messages
...
(use-package mode-icons
 ...
 (setq mode-icons-generate-emoji-xpms t
...
;; Emmet-mode: activate for sgml-mode and web-mode
