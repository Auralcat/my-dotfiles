...
* Macros
  #+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (fset 'auralcat/indent-whole-buffer
          (lambda (&optional arg) "Indents the whole buffer." (interactive "p") (kmacro-exec-ring-item (quote ("h=" 0 "%d")) arg)))

    (fset 'auralcat/ruby-extract-variable-to-private-method
          (lambda (&optional arg) "Extracts a variable declaration to a private method." (interactive "p") (kmacro-exec-ring-item (quote ([121 69 47 112 114 105 return 111 return 100 101 102 32 25 return escape 109 109 15 50 87 68 39 109 112 73 tab escape 15 100 100] 0 "%d")) argumento)))

    (fset 'auralcat/ruby-extract-var-declaration-to-method
          (lambda (&optional arg) "Takes a variable declaration out of a method and makes a new method for it. " (interactive "p") (kmacro-exec-ring-item (quote ([109 109 100 69 134217733 111 return 100 101 102 32 15 112 return escape 39 109 74 50 88 100 106 134217733 134217733 80 98 74 105 tab escape 39 109 100 100] 0 "%d")) arg)))

    (fset 'auralcat/ruby-extract-var-declaration-to-let
          (lambda (&optional arg) "Extracts a variable from an it clause and puts in a let statement." (interactive "p") (kmacro-exec-ring-item (quote ([100 100 134217745 134217729 112 99 87 108 101 116 40 58 25 escape 102 61 50 120 67 123 25 escape 86 61 15 15 48 119] 0 "%d")) argumento)))
