...
*** Golden Ratio Mode
    ...
    #+BEGIN_SRC emacs-lisp :tangle yes
      ...
      (add-to-list 'golden-ratio-extra-commands 'ace-window 'magit-status 'aw-flip-window)
      (golden-ratio-mode 1)
    #+END_SRC
...
* Org-mode
  #+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (define-key org-mode-map (kbd "M-RET") 'org-insert-subheading)
    ...
    (define-key org-mode-map (kbd "M-S-RET") 'org-insert-todo-heading-respect-content)
