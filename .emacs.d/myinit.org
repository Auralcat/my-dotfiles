...
(use-package lsp-mode
  ...
  :hook ((python-mode ruby-mode web-mode typescript-mode terraform-mode) . lsp)
  :config
...
#+begin_src emacs-lisp :tangle yes
;; I like IPython better
(setq python-shell-interpreter "ipython")
#+end_src
*** Importmagic
This is to replicate the import suggestion feature from PyCharm.
It's a necessity when working with Python code.

You will also need to install the ~epc~ and ~importmagic~ Python
libraries in your environment:
#+begin_src sh :export none :noeval
pip3 install epc importmagic
#+end_src
