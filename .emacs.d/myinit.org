...
(use-package ob-mermaid
  ...
  (when (string-equal (shell-command-to-string (format  "command -v %s" ob-mermaid-cli-path)) "")
  (async-shell-command "npm install -g @mermaid-js/mermaid-cli")))
#+END_SRC
* REPL
...
(use-package auto-package-update
  :hook (midnight . auto-package-update-now-async))
