...
covered by evil-collection."
  (let ((emacs-major-modes '(occur-mode
			     dired-mode
			     ibuffer-mode
			     package-menu-mode
			     comint-mode)))
...
* Browse-url
  ...
  (setopt browse-url-browser-display nil
    ...
    ;; 5. Webpositive
    ;; 6. Xterm
    ;; So this is why we need to add `browse-url-crome' directly here to use it as the default browser for `browse-url'.
    browse-url-browser-function 'browse-url-chrome
    browse-url-firefox-program "firefox"
    browse-url-chrome-program "flatpak run com.Google.Chrome")
  #+end_src
