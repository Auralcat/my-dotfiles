...
* Macros
  #+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (fset 'auralcat/enh-ruby-move-defun-forward
    ...
    (fset 'auralcat/enh-ruby-move-defun-backward
  ...
  #+RESULTS:
  | lambda | (&optional arg) | Moves a DEF block backwards in the class definition. | (interactive p) | (undo-boundary) | (noflet ((undo-boundary nil)) (kmacro-exec-ring-item (quote ([26 167772166 23 134217820 16 4 134217820 4 2 134217730 16 return 25 return 134217730 26] 0 %d)) arg)) | (undo-boundary) |
...
*** Enhanced-ruby-mode
    ...
    #+BEGIN_SRC emacs-lisp :tangle yes
      ...
      (define-key enh-ruby-mode-map (kbd "M-<down>") 'auralcat/enh-ruby-move-defun-forward)
      (define-key enh-ruby-mode-map (kbd "M-<up>") 'auralcat/enh-ruby-move-defun-backward)
    #+END_SRC
*** Web Mode
