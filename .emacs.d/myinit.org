...
(dolist (cmd '(org-forward-heading-same-level org-backward-heading-same-level org-next-visible-heading org-previous-visible-heading))
  (put cmd 'repeat-map 'org-heading-repeat-map))
#+END_SRC
** Markdown repeat maps
#+BEGIN_SRC emacs-lisp :tangle yes
(defvar markdown-heading-repeat-map
  (let ((map (make-sparse-keymap)))
...
(dolist (cmd '(markdown-outline-next
               markdown-outline-previous
               markdown-outline-next-same-level
               markdown-outline-previous-same-level))
  (put cmd 'repeat-map 'markdown-heading-repeat-map))
#+END_SRC
